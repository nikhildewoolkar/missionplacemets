//make a simple doubly linked list with all the operations like measure length,print, remove as well as add element at end and start, remove and add element at particular location show error when needed
...
class Operations{
  public LinkedListNode insertatEnd(Scanner scan, LinkedListNode head){
    ...
    if(head == null){
      LinkedListNode insertNode = new LinkedListNode(val, null, null);
      head = insertNode;
      return head;
    } else{
  ...
  public LinkedListNode insertatStart(Scanner scan, LinkedListNode head){
    int val = scan.nextInt();
    LinkedListNode tempnode = new LinkedListNode(val, head, null);
    return tempnode;
  }
